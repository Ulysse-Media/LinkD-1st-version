...
const addInvoice = async (req) => {
  ...
  var query = `INSERT INTO invoices (invoice_local_price, invoice_price, invoice_product, invoice_logistic, invoice_accommodation, invoice_transfer, invoice_honorary_speaker, invoice_extras, invoice_comments) values ('${req.invoice_local_price}', '${req.invoice_price}', '${invoice_product}', '${req.invoice_logistic}', '${req.invoice_accommodation}', '${req.invoice_transfer}', '${req.invoice_honorary_speaker}', '${req.invoice_extras}', '${req.invoice_comments}')`;
  try {
