...
const ActionsArchiving = () => {
    ...
    //     //             if (ArchivedDSMactions[l].status === "Validée par CDP et en attente de retour agenceet" en attente d'envoie BC") {
    ...
    //     //             if (ArchivedCDPactions[n].status === "Validée par CDP et en attente de retour agenceet" en attente d'envoie BC") {
    ...
    //     //             if (ArchivedMEDactions[q].status === "Validée par CDP et en attente de retour agenceet" en attente d'envoie BC") {
                        ...
                        {user.user_position === "VM" && (
                            <TableContainer component={Paper} style={{ height: '450px', overflow: "scroll" }}>
                                <Table className={classes.table} aria-label="simple table">
                                    ...
                                    <TableBody>
                                        {actionsUser.length > 0 ? actionsUser.filter((element, key) => element.status === "Terminée et non archivée" || element.status === "Terminée et archivée").map((row, index) => (
                                            <TableRow key={index}>
