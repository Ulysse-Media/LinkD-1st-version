...
export const actionsReducer = (
  ...
  switch (action.type) {
    ...
    // Fetch action by Other Staff request
    case FETCH_ACTION_BY_OTHER_STAFF_REQUEST:
      return {
        ...state,
        loading: true,
      };
    // Fetch action by Other Staff success
    case FETCH_ACTION_BY_OTHER_STAFF_SUCCESS:
      return {
        ...state,
        actionsOtherStaff: action.payload,
        loading: false,
      };
    // Fetch action by Other Staff failure
    case FETCH_ACTION_BY_OTHER_STAFF_FAILURE:
      return {
        ...state,
        loading: false,
      };
